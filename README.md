# NOTES FOR GALLIUM
Branched off dubnium and added comptability for:
- opencv 4
- latest version of PCL that requires c++14

Ideally we would want to pick all the latest changes from upstream and rebase our changes on top of those.
