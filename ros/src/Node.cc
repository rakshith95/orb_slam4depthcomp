           ...
           image_transport::ImageTransport& image_transport)
{
  ...
  // static parameters
  node_handle_.param(name_of_node_ + "/is_both_compressed", is_compressed_param_, false);
  node_handle_.param(name_of_node_ + "/is_onlyImage_compressed", is_OnlyImage_compressed_param_, false);
