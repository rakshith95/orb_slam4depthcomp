...
namespace ORB_SLAM2
{
Tracking::Tracking(System* pSys, ORBVocabulary* pVoc, FrameDrawer* pFrameDrawer, Map* pMap, KeyFrameDatabase* pKFDB,
...
bool Tracking::Relocalization()
{
  ...
  {
    mCurrentFrame.mTcw =
        cv::Mat::zeros(0, 0, CV_32F);  // this prevents a segfault later
